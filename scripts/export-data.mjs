...
function buildTalents(trackerRows) {
  return trackerRows
    ...
    .map((r, idx) => ({
      ...
      jobLink: r[3] || '',
      jobStatus: r[4] || '',
      postedToClaimedDays: num(r[5]),
      postedToClaimedFlag: r[6] || '',
      claimedToSentDays: num(r[7]),
      claimedToSentFlag: r[8] || '',
      sentToHireDays: num(r[9]),
      sentToHireFlag: r[10] || '',
      postedToHireDays: num(r[11]),
      postedToHireFlag: r[12] || '',
      talentName: r[16] || '',
      engagementStatus: r[17] || '',
      commitmentType: r[18] || '',
      weeklyHours: num(r[19]),
      hoursWarning: r[20] || '',
      onboardingStatus: r[21] || '',
      itopsTicketStatus: r[23] || '',
      coreEmailStatus: r[25] || '',
      topteamProfile: r[26] || '',
      correctReportTopteam: r[27] || '',
      budgetApproved: num(r[28]),
      budgetUsed: num(r[29]),
      pctUsed: num(r[31]),
      budgetStatus: r[32] || '',
      decisionDate: r[35] || null,
      decision: r[36] || '',
      decisionWarning: r[37] || '',
      required: r[38] || '',
      jobClosedStatus: r[40] || '',
      hoursRemovedStatus: r[42] || '',
      coreEmailRemovedStatus: r[44] || '',
      topteamRemovedStatus: r[46] || '',
      offboardingWarning: r[47] || '',
